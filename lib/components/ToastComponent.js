...
var ToastComponent = function (_Component) {
    ...
    _createClass(ToastComponent, [{
        ...
        value: function getTheme() {
            var base = (0, _deepmerge2.default)(_ToasterTheme2.default, this.props.baseTheme);
            if (this.props.theme) return (0, _deepmerge2.default)(base, this.props.theme);
            return base;
        }
    }, {
        key: 'getStyle',
        value: function getStyle() {
            ...
            var top = theme.base.top + theme.base.increment * idx;
            return _extends({}, theme.container, {
                top: top + 'px'
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                toBeRemoved = _props2.toBeRemoved;
